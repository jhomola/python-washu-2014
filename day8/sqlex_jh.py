...
engine = sqlalchemy.create_engine('sqlite:////Users/Jona/Documents/Uni/WashU2/4625-Programming/python-washu-2014/day8/inclass.db', echo=True)
...
class Team(Base):
  ...
  id = Column(Integer, primary_key=True)
  name = Column(String)
  players = relationship("Player", backref="team") 		# Multiple players can belong to one team
